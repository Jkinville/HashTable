...
#include <string> // atoi
#include <time.h>
//Include the stl list methods so I can use list in chaining.
#include <list>
...
HashTable::~HashTable() {
	...
	//Clear the bid vector and then delete its space in memory.
	bids.clear();
	delete &bids;
}
...
void loadBids(string csvPath, HashTable* hashTable) {
    ...
    csv::Parser file = csv::Parser("C:\\Users\\John\\Documents\\lab3-2\\eBid_Monthly_Sales_Dec_2016.csv");
